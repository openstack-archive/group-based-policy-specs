...
+---------------------+------------+-------------------------------+
|The following group of parameters are specified for the           |
|healthmonitor resource. These parameters are used to monitor the  |
|service VM.                                                       |
+---------------------+------------+-------------------------------+
...
|Optional                                                          |
|The following group of parameters are specified for the           |
|interfaces resource. These parameters are used to configure the   |
|interfaces in the service VM.                                     |
+---------------------+------------+-------------------------------+
|mgmt_ip              |string      |management port IP address     |
|                     |            |                               |
+---------------------+------------+-------------------------------+
...
|Optional                                                          |
|The following group of parameters are specified for the           |
|routes resource. These parameters are used to configure routes    |
|and Policy Based Routing rules on the service VM.                 |
+---------------------+------------+-------------------------------+
