...
* delete_network_function_device(device_data)
  ...
  Delete a Network Function Device
...
* plug_network_function_device_interface(device_data)
  ...
  Attach the specified ports to hotplug capable network function devices
...
* unplug_network_function_device_interface(device_data)
  ...
  Detach the ports from hotplug capable network function devices
...
+---------------------+------------+-------------------------------+
|                     |            |The following are valid when   |
|                     |            |resource is healthmonitor      |
+---------------------+------------+-------------------------------+
...
|                     |            |                               |
+---------------------+------------+-------------------------------+
|active_provider_mac  |string      |mac address of active          |
|                     |            |instance in case of HA         |
+---------------------+------------+-------------------------------+
|active_stitching_mac |string      |mac address of active          |
|                     |            |instance in case of HA         |
+---------------------+------------+-------------------------------+
|active_fip           |string      |Floating IP of active          |
|                     |            |instance in case of HA         |
+---------------------+------------+-------------------------------+
