...
are configured for Policy Targets. However, it will be done so by inheriting
from a new kind of Network Service Policy (NSP)  that will be assigned to a PTG.
